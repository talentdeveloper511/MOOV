...
import 'package:MOOV/models/todo_model.dart';
...
class FirestoreDatabase {
  ...
  Future<void> setUserData(UserModel userModel) async =>
      await _firestoreService.setData(
        path: FirestorePath.createFirebaseUser(uid),
        data: userModel.toMap(),
      );

  Future<dynamic> getUserData() async => await _firestoreService.getData(
        path: FirestorePath.getFirebaseUser(uid),
      );
