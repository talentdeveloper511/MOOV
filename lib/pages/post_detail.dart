...
class PostDetail extends StatefulWidget {
  ...
  PostDetail(this.bannerImage, this.title, this.description, this.startDate,
      this.profilePic, this.userName, this.userEmail, this.likedArray, this.moovId);

  @override
  State<StatefulWidget> createState() {
    return _PostDetailState(this.bannerImage, this.title, this.description,
        this.startDate, this.profilePic, this.userName, this.userEmail,
        this.likedArray, this.moovId);
  }
}
...
class _PostDetailState extends State<PostDetail> {
  ...
  dynamic startDate, moovId;
  List<dynamic> likedArray;
  _PostDetailState(this.bannerImage, this.title, this.description,
      this.startDate, this.profilePic, this.userName, this.userEmail,
      this.likedArray, this.moovId);
              ...
              Padding(
                ...
                child: Container(
                  child: Column(
                    ...
                    children: [
                      Icon(Icons.pages, color: TextThemes.ndBlue),
                    ],
                  ),
                ),
              )
