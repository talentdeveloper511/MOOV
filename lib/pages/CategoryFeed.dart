                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            textAlign:
                                                                                TextAlign.center,
                                                                            style:
                                                                                TextStyle(fontSize: 12.0, color: Colors.black.withOpacity(0.6)),
                                                                          ),
                                                                        ),
                                                                        Padding(
                                                                            padding:
                                                                    ...
                                                                    Row(
                                                                      children: [
                                                                        ...
                                                                        Column(
                                                                          children: [
                                                                            IconButton(
                                                                              icon: (isLiked1) ? new Icon(Icons.directions_run, color: Colors.green) : new Icon(Icons.directions_walk),
                                                                              color: Colors.red,
                                                                              iconSize: 30.0,
