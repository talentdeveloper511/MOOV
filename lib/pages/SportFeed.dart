...
import 'package:MOOV/widgets/sports_segmented_control.dart';
import 'home.dart';
...
class _SportFeedState extends State<SportFeed> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        //
        //                                             if (uidArray != null && uidArray.contains(strUserId)) {
        //                                               Database().removeGoing(strUserId, course.documentID, strUserName, strUserPic);
        //                                             } else {
        //                                               Database().addGoing(strUserId, course.documentID, strUserName, strUserPic);
        //                                             }
        //
        //                                           });
        //                                         },
